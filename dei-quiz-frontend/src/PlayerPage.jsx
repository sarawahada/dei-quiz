...
export default function PlayerPage() {
  ...
  useEffect(() => {
    ...
    socket.on("showResults", (res) => {
      ...
      const colors = { Equalizer:"#6CC4A1", Bridgebuilder:"#FFB347", Catalyst:"#FF8C42", "Devil Advocate":"#6B8DD6" };
  ...
  if (!joined) {
    return (
      <div style={{
        ...
        <h2 style={{ fontFamily: "'Pacifico', cursive", marginBottom: 20 }}>DEI Change Agent Quiz</h2>
        <input
          placeholder="Enter your name"
          value={name}
          onChange={(e) => setName(e.target.value)}
          style={{ padding: 10, fontSize: "1.1em", borderRadius: 10, border: "1px solid #dcd0c0" }}
        />
      ...
      {question ? (
        ...
        <div>
          ...
          <div style={{ marginTop: 30 }}>
            <canvas ref={chartRef} style={{ maxWidth: 400, margin: "0 auto", background: "rgba(255,250,240,0.8)", borderRadius: 20, boxShadow: "2px 4px 12px rgba(0,0,0,0.1)" }} />
          </div>
